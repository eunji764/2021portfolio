...
},{"process":"node_modules/process/browser.js"}],"node_modules/ssr-window/ssr-window.esm.js":[function(require,module,exports) {
"use strict";
...
function scrollDown() {
  var afterOffset = window.scrollY;
...
function star() {
  var stars = document.querySelectorAll('.star_box .star'),
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return typing(title, introTitle);
...
new ScrollMagic.Scene({
  ...
  triggerHook: .4
}).setClassToggle(about, 'show').addTo(new ScrollMagic.Controller()); // PROGRASS
...
function prograss(type, percent) {
  var circleBoxs = Array.from(document.querySelectorAll('.circle_prograss_box')),
      circles = circleBoxs.map(function (circleBox) {
    return circleBox.querySelector('.prograss_circle');
  }),
      spans = circleBoxs.map(function (circleBox) {
    return circleBox.querySelector('strong');
  }),
...
floatingObject('.cloud6', 1.3, 10); // back-to-position

var spyEls = document.querySelectorAll('article.scroll-spy');
...
new _bundle.default('.design .swiper-container', {
  direction: 'horizontal',
  slidesPerView: 3,
  spaceBetween: 20,
  centeredSlides: true,
...
},{"q":"node_modules/q/q.js","swiper/bundle":"node_modules/swiper/swiper-bundle.esm.js","swiper/swiper-bundle.css":"node_modules/swiper/swiper-bundle.css","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","dom7":"node_modules/dom7/dom7.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
